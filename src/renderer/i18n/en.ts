...
const lang = {
  ...
  beat: {
    ...
    html_tailwind: {
      ...
      materialsDialogTitle: "Select Material Image",
      materialsDialogDescription: "Choose an image from your Materials to apply the effect.",
      noPreview: "No preview",
      duration: "Duration (sec)",
      durationMin: "min = 1.0 sec",
      durationMax: "max = no limit",
      zoom: "Zoom (%)",
      zoomMin: "min = 100%",
      zoomMax: "max = 200%",
      panFrom: "Move From (%)",
      ...
      panRangeMin: "min = 0%",
      panRangeMax: "max = 100%",
      panRangeNoteX: "Image position scale: 0 = right, 50 = center, 100 = left",
      panRangeNoteY: "Image position scale: 0 = bottom, 50 = center, 100 = top",
      panDirectionNoteRight: "moveToRight default: 100 -> 0",
      panDirectionNoteLeft: "moveToLeft default: 0 -> 100",
      panDirectionNoteTop: "moveToTop default: 0 -> 100",
      panDirectionNoteBottom: "moveToBottom default: 100 -> 0",
  ...
  parameters: {
    ...
    captionParams: {
      ...
      captionSplitDescription: "Split captions at: ",
      newline: "newline",
