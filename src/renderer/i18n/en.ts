...
const lang = {
  ...
  beat: {
    ...
    mediaFile: {
      ...
      libraryTitle: "Select Project Media",
      libraryDescription: "Choose an image or movie generated for this project.",
      libraryEmpty: "No generated media were found for this project.",
      libraryLoadError: "Failed to load the project media.",
    },
    mediaImageFile: {
      label: "Image file",
    },
