...
const lang = {
  ...
  parameters: {
    ...
    transitionParams: {
      ...
      typeFade: "Fade",
      // Slide Transitions
      typeSlideoutLeft: "Slide Out Left",
      typeSlideoutRight: "Slide Out Right",
      typeSlideoutUp: "Slide Out Up",
      typeSlideoutDown: "Slide Out Down",
      typeSlideinLeft: "Slide In Left",
      typeSlideinRight: "Slide In Right",
      typeSlideinUp: "Slide In Up",
      typeSlideinDown: "Slide In Down",
      // Wipe Transitions
      typeWipeleft: "Wipe Left",
      typeWiperight: "Wipe Right",
      typeWipeup: "Wipe Up",
      typeWipedown: "Wipe Down",
      typeWipetl: "Wipe Top-Left",
      typeWipetr: "Wipe Top-Right",
      typeWipebl: "Wipe Bottom-Left",
      typeWipebr: "Wipe Bottom-Right",
    },
    speechParams: {
      ...
      stabilityTooltip: "Determines how stable the voice is and the randomness between each generation. Lower values introduce broader emotional range for the voice. Higher values can result in a monotonous voice with limited emotion.",
  ...
  decorationList: {
    kotodama: {
      ...
      confused: "Confused",
      confused_en: "Confused (English)",
      crying: "Crying",
      crying_en: "Crying (English)",
      disgusted: "Disgusted",
      disgusted_en: "Disgusted (English)",
      friendly: "Friendly",
      friendly_en: "Friendly (English)",
      happy: "Happy",
      happy_en: "Happy (English)",
      interested: "Interested",
      interested_en: "Interested (English)",
      laughing: "Laughing",
      laughing_en: "Laughing (English)",
      neutral: "Neutral",
      neutral_en: "Neutral (English)",
      sad: "Sad",
      sad_en: "Sad (English)",
      scared: "Scared",
      scared_en: "Scared (English)",
      surprised: "Surprised",
      surprised_en: "Surprised (English)",
      laughing_speech: "Laughing Speech",
      laughing_speech_en: "Laughing Speech (English)",
      crying_speech: "Crying Speech",
      crying_speech_en: "Crying Speech (English)",
      very_happy: "Very Happy",
      very_happy_en: "Very Happy (English)",
    },
  },
  updater: {
  ...
  voiceClone: {
    ...
    apiKeyRequired: {
      ...
      description: "Please set your ElevenLabs API key in Settings to use voice cloning features",
    },
    ...
    errors: {
      loadFailed: "Failed to load cloned voices",
      uploadFailed: "Failed to upload voice clone",
      updateFailed: "Failed to update voice name",
      deleteFailed: "Failed to delete voice clone",
      apiKeyInvalid: "Invalid ElevenLabs API key",
      permissionDenied: "Permission denied. Please check your ElevenLabs API key permissions.",
    },
  },
  nativeMenu: {
    fileMenu: "File",
