  ...
  project: {
    ...
    scriptEditor: {
      ...
      reference: {
        ...
        description:
          'This keeps the character’s appearance consistent when generated by AI. Create the character image using an "image generation prompt" or upload your own. Then, in each BEAT, specify the "{key}" in "{imageParamsImages}".',
      },
