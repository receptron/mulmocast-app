...
const lang = {
  ...
  beat: {
    ...
    html_tailwind: {
      ...
      zoomMin: "min = 100%",
      zoomMax: "max = 200%",
      panDistance: "Move Distance (%)",
      panDistanceMin: "min = 1%: subtle move",
      panDistanceMax: "max = 50%: strongest move",
      panDistanceNote: "(actual move may be clamped to avoid black borders)",
