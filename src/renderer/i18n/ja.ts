...
const lang = {
  ...
  beat: {
    ...
    html_tailwind: {
      ...
      materialsDialogTitle: "Material画像を選択",
      materialsDialogDescription: "エフェクトを適用する画像をMaterialsから選んでください。",
      noPreview: "プレビューなし",
      duration: "時間（秒）",
      ...
      panRangeMin: "min = 0%",
      panRangeMax: "max = 100%",
      panRangeNoteX: "画像位置スケール: 0=右, 50=中央, 100=左",
      panRangeNoteY: "画像位置スケール: 0=下, 50=中央, 100=上",
      panDirectionNoteRight: "右へ移動の初期値: 100 -> 0",
      panDirectionNoteLeft: "左へ移動の初期値: 0 -> 100",
      panDirectionNoteTop: "上へ移動の初期値: 0 -> 100",
      panDirectionNoteBottom: "下へ移動の初期値: 100 -> 0",
  ...
  parameters: {
    ...
    captionParams: {
      ...
      captionSplit: "字幕分割",
      captionSplitDescription: "次の文字で字幕を分割します:",
      newline: "改行",
      fullWidth: "全角",
      halfWidth: "半角",
    },
