...
const lang = {
  ...
  beat: {
    ...
    mediaFile: {
      ...
      libraryTitle: "プロジェクトメディアを選択",
      libraryDescription: "このプロジェクトで生成された画像または動画から選択してください。",
      libraryEmpty: "このプロジェクトで生成されたメディアが見つかりませんでした。",
      libraryLoadError: "プロジェクトのメディアを読み込めませんでした。",
    },
    mediaImageFile: {
      label: "画像ファイル",
    },
