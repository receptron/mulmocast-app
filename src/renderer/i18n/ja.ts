  ...
  project: {
    ...
    chat: {
      ...
      templates: {
        ...
        characters: "複数キャラクターの物語",
        children_book: "子供向け絵本",
        coding: "コーディングプレゼンテーション",
        comic_strips: "アメリカン・コミック風ストリップ",
        documentary: "ドキュメンタリー",
        drslump_comic: "Dr.スランプ風",
        ghibli_comic: "ジブリ風コミック",
        ghibli_comic_strips: "ジブリ風コミックストリップ",
        ghost_comic: "攻殻機動隊風",
        html: "HTMLによるビジネスプレゼンテーション",
        image_prompt: "画像生成用プロンプト",
        onepiece_comic: "ワンピース風",
        portrait_movie: "写真のようにリアルなポートレート映画",
        realistic_movie: "写真のようにリアルな映画テンプレート",
        sensei_and_taro: "先生と太郎",
        shorts: "短編映画テンプレート",
        sifi_story: "SF風マルチキャラクター物語",
        trailer: "映画予告編テンプレート",
        vision: "ビジネス分析",
      },
      prompt: {
