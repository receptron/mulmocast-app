...
- 5フェーズ構成:
  - **Phase 1 – Setup**: Settings ブランク化、Pro モード設定、テストプロジェクト作成
  - **Phase 2 – Blank defaults**: Image / Movie 両方で Settings ブランク時の blank ON/OFF サイクル
...
7. `test/automated_branding_e2e_test.ts`
